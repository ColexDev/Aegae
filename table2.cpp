...
void create_column(int longest, int subtract, int value)
{
    for (int i = 0; i < longest - subtract; i++) {
        mvprintw(3, value + i, "-");
    }
}
...
void draw_header(std::vector<std::string> &vec)
{
    ...
    total = longestDate + longestType + longestAmount + longestCategory + longestDescription + 5;
